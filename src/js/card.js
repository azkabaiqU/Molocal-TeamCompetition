document.addEventListener('DOMContentLoaded', () => {
    const cardsData = {
        terkini: [
            ...
            {
                contImg: 'https://images.unsplash.com/photo-1559628233-100c798642d4?q=80&w=2540&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
                img: '/img/lensV2.png',
                nama: 'Oggie',
                ago: '2 jam yang lalu',
            ...
            {
                contImg: 'https://i.pinimg.com/564x/4e/e8/14/4ee81419918e99fa81f858bec9db224f.jpg',
                img: '/img/azka.png',
                nama: 'azka',
                ago: '1 jam yang lalu',
            ...
            {
                contImg: 'https://i.pinimg.com/564x/17/7a/68/177a6899ddaaa3cabdd6de4350a531e7.jpg',
                img: '/img/azka.png',
                nama: 'azka',
        ...
        wisata: [{
            ...
            {
                contImg: 'https://images.unsplash.com/photo-1523810804307-760585ed63cd?q=80&w=2837&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
                img: '/img/amar.png',
                nama: 'ammar',
                ago: '4 hari yang lalu',
        ...
        kuliner: [{
                contImg: 'https://i.pinimg.com/564x/c4/b0/82/c4b082d6eb09cc8fb99b0418422805e6.jpg',
                img: '/img/amar.png',
                nama: 'ammar',
                ago: '2 menit yang lalu',
            ...
            {
                contImg: 'https://i.pinimg.com/564x/4b/d2/9a/4bd29a33347b4f1cab2254e8dff54046.jpg',
                img: 'https://asianwiki.com/images/3/32/Sweet_Home_3-Choi-Go.jpg',
                nama: 'Choi Go',
                ago: '14 hari yang lalu',
            ...
            {
                contImg: 'https://i.pinimg.com/564x/a1/b7/71/a1b7718c18e2afe299187e6986d18fcf.jpg',
                img: 'https://asianwiki.com/images/3/32/Sweet_Home_3-Choi-Go.jpg',
                nama: 'Choi Go',
                ago: '7 hari yang lalu',
                ...
                type: 'Kuliner',
                membaca: '19 menit membaca',

                id: '6',},
        ],
        kerajinan: [{
                contImg: 'https://i.pinimg.com/564x/1d/e2/fa/1de2fa25c21fb53c0d609a8fa285a3ab.jpg',
                img: '/img/azka.png',
                nama: 'azka',
                ago: '4 jam yang lalu',
            ...
            {
                contImg: 'https://i.pinimg.com/736x/48/66/ae/4866ae94a99902d7351dfa79bb8a3fa4.jpg',
                img: '/img/amar.png',
                nama: 'ammar',
                ago: '1 jam yang lalu',
            ...
            {
                contImg: 'https://i.pinimg.com/564x/37/ed/3b/37ed3b1d8a1dcb6bd85839ae7bcff142.jpg',
                img: 'https://resize.indiatvnews.com/en/resize/newbucket/1080_-/2024/01/bloodhounds-1704786617.webp',
                nama: 'Lee Sang-yi',
                ago: '10 hari yang lalu',
        ...
        ekonomi: [{
                contImg: 'https://i.pinimg.com/564x/89/6d/e8/896de82d07b5cf78b203039e043f1c41.jpg',
                img: '/img/lensV2.png',
                nama: 'Oggie',
                ago: '1 jam yang lalu',
            ...
            {
                contImg: 'https://i.pinimg.com/564x/52/09/be/5209be383be388b6237ec51ca4c2ee5d.jpg',
                img: '/img/azka.png',
                nama: 'azka',
                ago: '3 jam yang lalu',
            ...
            {
                contImg: 'https://i.pinimg.com/564x/96/3d/86/963d86ac58e19ad7e659ef4dc0847466.jpg',
                img: 'https://m.media-amazon.com/images/M/MV5BOGQ0NTk5MTEtMTAxMS00NGEwLTk4MDItNTRiNTExYTZlYWVhXkEyXkFqcGc@._V1_.jpg',
                nama: 'Bong gil',
                ago: '1 jam yang lalu',
        ...
        bahasa: [{
            ...
            {
                contImg: 'https://i.pinimg.com/564x/0d/5d/1f/0d5d1f302c87ec8f3ac6626e44a7e82f.jpg',
                img: '/img/amar.png',
                nama: 'ammar',
                ago: '1 jam yang lalu',
            ...
            {
                contImg: 'https://i.pinimg.com/564x/f5/21/0b/f5210be3e8de71e11b26b4e9c498f6b3.jpg',
                img: 'https://resize.indiatvnews.com/en/resize/newbucket/1080_-/2024/01/bloodhounds-1704786617.webp',
                nama: 'Lee Sang-yi',
                ago: '1 jam yang lalu',
        ...
        acara: [{
                contImg: 'https://i.pinimg.com/736x/2d/4a/35/2d4a35a0a95ff4d632d69be7728cf2fb.jpg',
                img: 'https://awsimages.detik.net.id/community/media/visual/2024/02/06/sweet-home-3-2026_11.jpeg?w=500&q=90',
                nama: 'Cha Hyun So',
                ago: '1 jam yang lalu',
            ...
            {
                contImg: 'https://i.pinimg.com/564x/ae/cc/74/aecc744a94b5f5af736b97376970827a.jpg',
                img: 'https://static0.srcdn.com/wordpress/wp-content/uploads/2023/11/sweet-home-season-one-eun-hyeok-headphones.jpg',
                nama: 'Lee Eun-hyuk',
                ago: '1 jam yang lalu',
            ...
            {
                contImg: 'https://i.pinimg.com/564x/f2/e9/f0/f2e9f0efff2dfd584644ef61b9b0abbe.jpg',
                img: 'https://static0.srcdn.com/wordpress/wp-content/uploads/2023/11/sweet-home-season-one-eun-hyeok-headphones.jpg',
                nama: 'Lee Eun-hyuk',
                ago: '1 bulan yang lalu',
    ...
    const contentContainer = document.getElementById('scrollArticle');
    const boxButtons = document.querySelectorAll('.box-button');

    // Function to update the content
    function updateContent(boxId) {
        contentContainer.innerHTML = ''; // Clear previous content
        const cards = cardsData[boxId] || []; // Get the cards for the selected category

        cards.forEach(cardData => {
            const card = document.createElement('a');
            card.setAttribute('href', '#');
            card.setAttribute('class', 'sm:w-[440px] w-full  mr-[20px]');
            ...
            const cardInnerHtml = `
                        <div class="sm:w-[440px] max-w-[440px] min-w-[370px] w-full sm:h-[320px] h-[300px] overflow-hidden rounded-xl">
                            <img class="object-cover w-full h-full"
                                src="${cardData.contImg}" alt="img">
                        </div>
                        <div class="mt-[12px]">
                            <div class="flex items-center pjs-m w-full">
                                <div class="w-[40px] h-[40px]  overflow-hidden rounded-full mr-[12px]">
                                    <img class="object-cover  w-full h-full" src="${cardData.img}" alt="img">
                                </div>
                                <h1 class="  sm:text-[24px] text-[20px] pjs-r text-black">${cardData.nama}</h1>
                                <p class="pjs-l text-[16px] text-black/10 px-[12px] ">|</p>
                                <p class="textGray  text-[16px] text-black/40 pjs-l">${cardData.ago}</p>
                            </div>
                            <h1 class="my-[8px] sm:text-[28px] text-[24px] pjs-m line-clamp-2 leading-[36px] text-black/80">
                            ${cardData.title}
                            </h1>
                            ...
                            <div class="flex items-center">
                                <h1 class="pjs-r text-[14px] textRed">${cardData.type}</h1>
                                <p class="pjs-l text-[12px] text-black/10 px-[12px] ">|</p>
                                <p class="textGray  text-[14px]  textBlack pjs-r">${cardData.membaca}</p>
                            </div>
                        </div>
    ...
    updateContent('terkini'); // Default category to load on page load
});